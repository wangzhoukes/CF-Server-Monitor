...
const translations = reactive({
  en: {
    ...
    ghProxy: 'Third-party GitHub Proxy (Use at your own risk)',
    ...
    demo: 'Demo',
    view: 'View',
    addVirtualServer: 'ADD VIRTUAL',
    virtualServerConfig: 'Virtual Server Config',
    virtualServerAdded: 'Virtual server added',
    virtualServerUpdated: 'Virtual server updated',
    invalidCpuRange: 'CPU min cannot exceed max',
    invalidRamRange: 'RAM usage min cannot exceed max',
    invalidNetInRange: 'Download speed min cannot exceed max',
    invalidNetOutRange: 'Upload speed min cannot exceed max',
    serverNotFound: 'Server not found',
    notVirtualServer: 'Not a virtual server',
    editVirtualServer: 'Edit Virtual Server',
  },
  zh: {
    ...
    demo: '演示',
    view: '查看',
    addVirtualServer: '添加虚拟',
    virtualServerConfig: '虚拟服务器配置',
    virtualServerAdded: '虚拟服务器已添加',
    virtualServerUpdated: '虚拟服务器已更新',
    invalidCpuRange: 'CPU 下限不能超过上限',
    invalidRamRange: '内存使用率下限不能超过上限',
    invalidNetInRange: '下载速度下限不能超过上限',
    invalidNetOutRange: '上传速度下限不能超过上限',
    serverNotFound: '服务器不存在',
    notVirtualServer: '该服务器不是虚拟服务器',
    editVirtualServer: '编辑虚拟服务器',
  }
})
